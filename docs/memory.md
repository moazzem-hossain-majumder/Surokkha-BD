...
- **Current task:** Phase 3 (auth, roles, admin dashboard, community reports) complete and pending your live verification. Next: run through supabase/tests/manual_rls_checklist.md, rotate the service_role key (it was pasted in chat), then Phase 4 (ReliefLink, Volunteer Hub)
